<?php $user = $app['database']->selectRow('users', $_SESSION['string_email'], 'email'); ?>
...
<div class="border border-blue-300 flex justify-center">
    <?php if (isset($_SESSION)) : ?>
        <div class="flex justify-between items-center font-bold container">
            ...
            <a class="border border-blue-300 p-2 bg-blue-500 text-white hover:bg-blue-900 rounded m-2" href="/"><h3>Home</h3></a>
            ...
            <?php if (strpos($user[0]['role'], 'customer') === false || strpos($user[0]['role'], 'owner') === true)  : ?>
            ...
            <?php if ((strpos($user[0]['role'], 'owner') === false && strpos($user[0]['role'], 'customer') === false)) : ?>
